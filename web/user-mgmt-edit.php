...
<html>
	...
	<body>
		...
		<div class="breadcrumbs">
			...
			<form action = "user-mgmtEDIT.php" method = "post" >
			<button type="submit" class="btn-edit">Edit User</button>
		</div>
			<div align="center">
			<style>
				table, th, td {
				...
				&nbsp&nbsp 1. Enter the User's ID number'(User ID) of the record that is to be edited.<br>
				&nbsp&nbsp 2. Enter the information on the fields.<br>
				&nbsp&nbsp 3. Click on the "Edit User" button after entering all the information.<br>
				...
				<tr>
				<td style="background-color:#979797;"><h2>Name:</h2></td><td><input type="text" name= "name" id = "name"></td>
				</tr>
				<tr>
				<td style="background-color:#979797;"><h2>Email:</h2></td><td><input type="text" name= "email" id = "email"></td>
				</tr>
				<tr>
				<td style="background-color:#979797;"><h2>Address:</h2></td><td><input type="text" name= "address" id = "address"></td>
				</tr>
				<tr>
				<td style="background-color:#979797;"><h2>Contact:</h2></td><td><input type="text" name= "contact" id = "contact"></td>
				</tr>
				</table>
				<br><br>
				</form>
