...
<html>
	...
	<body>
		...
		<div class = "breadcrumbs">
				<h4><a href="userhomepage.php">Home</a>><a href="">Category</a>
		</div>
		...
		<div class = "container py-5">
								...
								<div class = "col-md-4">
									<div class = "card" >
										<div class = "card-body" >
											...
											<center><h2 class = "card-title"><a href='itemPage.php?id=<?php echo  $row["ProductId"] ?>' style = "font-size:30px; text-decoration:none; color: black;"><?php echo $row['ProductName']?></a></h2></center>
			...
			<div class = "cat-button"align = "right">
				...
				<a href = "userhomepage.php"><button class = "b-btn">Back</button></a>
			</div>
		</div>
