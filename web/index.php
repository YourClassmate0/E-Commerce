						...
						if ($result->num_rows > 0) {
							while ($row = $result -> fetch_assoc()) {
								...
								<div class = "col-md-4">
									<div class = "card">
										<div class = "card-body">
											<center><a href='clothe.php?id=<?php echo  $row["CategoryId"] ?>'><?php echo '<img src = "data:image;base64,'.base64_encode($row['CategoryImg']).'" style = "width: 315px; height: 250px;" > ';?></a></center>
											<center><h2 class = "card-title"><a href='clothe.php?id=<?php echo  $row["CategoryId"] ?>' style = "font-size:30px; text-decoration:none; color: black; "><?php echo $row['CategoryName']?></a></h2></center>
